...
void paskirtytiStud(list<Stud> &studentai, list<Stud> &saunuoliai, list<Stud> &nevykeliai, char pasirinkimas) {
    copy_if(studentai.begin(), studentai.end(), back_inserter(saunuoliai), [pasirinkimas](const Stud& s) {
        return galutinis(s, pasirinkimas) >= 5.0;
    });

    copy_if(studentai.begin(), studentai.end(), back_inserter(nevykeliai), [pasirinkimas](const Stud& s) {
        return galutinis(s, pasirinkimas) < 5.0;
    });
}
