...
void paskirtytiStud(std::vector<Stud>& studentai, std::vector<Stud>& nevykeliai, char pasirinkimas) {
    for (auto i = studentai.begin(); i != studentai.end();) {
        if (galutinis(*i, pasirinkimas) <= 5.0) {
